angular.module('xenon.directives', []).
	...
	directive('settingsPane', function(){
		return {
			restrict: 'E',
			templateUrl: appHelper.templatePath('xenon/layout/settings-pane'),
	...
	directive('horizontalMenu', function(){
		return {
			restrict: 'E',
			replace: true,
			templateUrl: appHelper.templatePath('xenon/layout/horizontal-menu'),
	...
	directive('sidebarMenu', function(){
		return {
			restrict: 'E',
			templateUrl: appHelper.templatePath('xenon/layout/sidebar-menu'),
	...
	directive('sidebarChat', function(){
		return {
			restrict: 'E',
			replace: true,
			templateUrl: appHelper.templatePath('xenon/layout/sidebar-chat')
		};
	}).
	directive('footerChat', function(){
		return {
			...
			templateUrl: appHelper.templatePath('xenon/layout/footer-chat')
		};
	}).
	directive('sidebarLogo', function(){
		return {
			restrict: 'E',
			replace: true,
			templateUrl: appHelper.templatePath('xenon/layout/sidebar-logo')
		};
	}).
	directive('sidebarProfile', function(){
		return {
			restrict: 'E',
			replace: false,
			templateUrl: appHelper.templatePath('xenon/layout/sidebar-profile')
		};
	}).
	directive('userInfoNavbar', function(){
		return {
			restrict: 'E',
			replace: true,
			templateUrl: appHelper.templatePath('xenon/layout/user-info-navbar')
		};
	}).
	directive('pageTitle', function(){
		return {
			restrict: 'E',
			replace: true,
			templateUrl: appHelper.templatePath('xenon/layout/page-title'),
	...
	directive('siteFooter', function(){
		return {
			restrict: 'E',
			templateUrl: appHelper.templatePath('xenon/layout/footer')
		};
	}).
